    ...
    if (Environment.type === EnvironmentType.Local) {
      ...
      element = React.createElement(
        ListForm,
        {
          ...
          formLayoutType: this.properties.formLayoutType,
      ...
      element = React.createElement(
        ConfigureWebPart,
        {
          ...
          layoutTypeFieldLabel: strings.LayoutTypeFieldLabel,
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    const mainGroup = {
      ...
      groupFields: [
        ...
        PropertyPaneDropdown('formLayoutType', {
          label: strings.LayoutTypeFieldLabel,
          options: Object.keys(LayoutMode)
            .map((k1) => LayoutMode[k1]).filter((v1) => typeof v1 === 'string')
            .map((n1) => ({ key: LayoutMode[n1], text: n1 })),
          disabled: !this.properties.listUrl
        })
