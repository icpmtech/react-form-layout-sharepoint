...
export default class DraggableComponent extends React.Component<IDraggableComponentProps> {
  ...
  public render() {
    ...
    debugger;
    let draggableComponentCss = styles.draggableComponent;
    if (this.props.typeLayout == LayoutMode.Grid) {
      draggableComponentCss += ' ' + styles.draggableComponentGrid;
    }
    return connectDropTarget(connectDragSource(
      <div className={css('ard-draggableComponent', draggableComponentCss, isDragging ? styles.isDragging : null)}>
        {children}
